...
\begin{lstlisting}[basicstyle=\small, language=C, label=lst:code, caption=Output of global variable initialisation, captionpos=b]
export void __init (  ) 
{
        a = 321;
        b = 1.000000;
...
\begin{lstlisting}[basicstyle=\small, language=C, label=lst:code, caption=Output of local variable initialisation, captionpos=b]    
export int foo() 
{
    int a;
    int b;
